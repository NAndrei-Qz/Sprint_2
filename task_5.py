...
#пишем цикл сразу для двух объектов
#пишем вложенный цикл, который перебирает названия методов из списка методов
#с помощью getattribute получаем метод по названию из перебираемого списка и сразу же печатаем вызов "объект.метод()"
